...
url="https://ctflearn.com/user/GuillaumeDupuy"
...
solved = soup.find("span", {"class": "font-primary mt-2"}).text.strip()

solved = solved.split("th")[0]
...
data.append("✅ Number of Challenges Finish: 43\n")
data.append("```\n")
